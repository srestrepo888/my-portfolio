  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* Playfair Display - Didone-style serif for EXPERIENCE */}
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
          rel="stylesheet"
        />
        
        {/* Libre Baskerville - Transitional serif for ARCHITECT */}
        <link
          href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&display=swap"
          rel="stylesheet"
        />
        
        {/* Lato - Clean sans-serif for navigation */}
        <link
